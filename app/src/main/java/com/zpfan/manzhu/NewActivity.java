...
public class NewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initRV() {
        ...
        mRvIdel.setLayoutManager(new LinearLayoutManager(NewActivity.this));
        mTopmenu = (LinearLayout) mIcontoplin.findViewById(R.id.ll_topmenu);
        mEmptyview = View.inflate(NewActivity.this, R.layout.rv_emptyview, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_top3:
                ...
                mMap.put("issale", "false");
                mMap.put("is_deposit", "");
                mMap.put("is_package", "true");
                getData();
                break;
            case R.id.ll_top4:
                //点击删选的逻辑。。。
                mPopupWindow = new PopupWindow(NewActivity.this);
                View inflate = View.inflate(NewActivity.this, R.layout.idle_pop, null);
                initPopView(inflate);
                WindowManager.LayoutParams lp = NewActivity.this.getWindow()
                        .getAttributes();
                lp.alpha = 0.4f;
                NewActivity.this.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
                NewActivity.this.getWindow().setAttributes(lp);
    ...
    private void initFilterRv(final PopupWindow window) {
        mRvfilter.setLayoutManager(new LinearLayoutManager(NewActivity.this));
    ...
    private void showDrawable(int i) {
        ...
        switch (i) {
            case 1:
                ...
                mIvtop2.setImageResource(R.mipmap.com_icon_dep_ept);
                mTvtop2.setTextColor(getResources().getColor(R.color.secondtextcolor));
                mIvtop3.setImageResource(R.mipmap.com_icon_freship_ept);
            ...
            case 2:
                ...
                mIvtop2.setImageResource(R.mipmap.com_icon_dep);
            ...
            case 3:
                ...
                mIvtop2.setImageResource(R.mipmap.com_icon_dep_ept);
                mTvtop2.setTextColor(getResources().getColor(R.color.secondtextcolor));
                mIvtop3.setImageResource(R.mipmap.com_icon_freship);
