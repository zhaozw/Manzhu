...
public class PhotoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.searchtoplin)
    SearchTopLin mSearchtoplin;
    ...
    private ImageView mSearchiv1;
    private ImageView mSearchiv2;
    private TextView mSearchtv1;
    private TextView mSearchtv2;
    private LinearLayout mLlsearchetop;
    private LinearLayout mLlsearchetop1;
    private LinearLayout mLlsearchetop2;
    private LinearLayout mLlsearchetop3;
    ...
    private void initTopmenu() {
        ...
        mSearchiv1 = (ImageView) mSearchtoplin.findViewById(R.id.iv_searchtop1);
        mSearchiv2 = (ImageView) mSearchtoplin.findViewById(R.id.iv_searchtop2);

        mSearchtv1 = (TextView) mSearchtoplin.findViewById(R.id.tv_searchtop1);
        mSearchtv2 = (TextView) mSearchtoplin.findViewById(R.id.tv_searchtop2);
        mLlsearchetop = (LinearLayout) mSearchtoplin.findViewById(R.id.ll_searchtop);
        ...
        mLlsearchetop1.setOnClickListener(this);
        mLlsearchetop2.setOnClickListener(this);
        mLlsearchetop3.setOnClickListener(this);
    ...
    private void toFilter() {
        mPopupWindow = new PopupWindow(PhotoActivity.this);
        View inflate = View.inflate(PhotoActivity.this, R.layout.idle_pop, null);
        initPopView(inflate);
        WindowManager.LayoutParams lp = PhotoActivity.this.getWindow()
                .getAttributes();
        lp.alpha = 0.4f;
        PhotoActivity.this.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
        PhotoActivity.this.getWindow().setAttributes(lp);
    ...
    private void showDrawable(int i) {
        ...
        switch (i) {
            ...
            case 4:
                //设置搜索界面的数据替换
                mSearchiv1.setImageResource(R.mipmap.com_icon_serv);
                mSearchtv1.setTextColor(getResources().getColor(R.color.maintextcolor));
                mSearchiv2.setImageResource(R.mipmap.com_icon_loca_gra);
                mSearchtv2.setTextColor(getResources().getColor(R.color.secondtextcolor));

                break;
            case 5:

                mSearchiv1.setImageResource(R.mipmap.com_icon_serv_ept);
                mSearchtv1.setTextColor(getResources().getColor(R.color.secondtextcolor));
                mSearchiv2.setImageResource(R.mipmap.com_icon_loca);
                mSearchtv2.setTextColor(getResources().getColor(R.color.maintextcolor));
