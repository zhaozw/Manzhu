...
public class MakeUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initRV() {
        ...
        mEmptyview = View.inflate(MakeUpActivity.this, R.layout.rv_emptyview, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_top4:
                //点击删选的逻辑。。。
                mPopupWindow = new PopupWindow(MakeUpActivity.this);
                View inflate = View.inflate(MakeUpActivity.this, R.layout.idle_pop, null);
                initPopView(inflate);
                WindowManager.LayoutParams lp = MakeUpActivity.this.getWindow()
                        .getAttributes();
                lp.alpha = 0.4f;
                MakeUpActivity.this.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
                MakeUpActivity.this.getWindow().setAttributes(lp);
    ...
    private void initFilterRv(final PopupWindow window) {
        mRvfilter.setLayoutManager(new LinearLayoutManager(MakeUpActivity.this));
