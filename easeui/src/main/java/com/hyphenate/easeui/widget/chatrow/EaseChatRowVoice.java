...
public class EaseChatRowVoice extends EaseChatRowFile{
    ...
    protected void onFindViewById() {
        ...
        mBubble = (RelativeLayout) findViewById(R.id.bubble);
    }
    ...
    protected void onSetUpView() {
        ...
        if(len>0){
            ...
            //百分比显示语音控件的长度
            ViewGroup.LayoutParams params = mBubble.getLayoutParams();

            float scale = getContext().getResources().getDisplayMetrics().density;
            int dp = (int) ( (50 +len *5) * scale + 0.5f);
            int maxdp = (int) (260 * scale + 0.5f);
            int mindp = (int) (80 * scale + 0.5f);
