    ...
    private void addonversationCToDB(final int msgCount) {
        ...
        list.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                ArrayList<AvatorBean> avatorBeen = mGson.fromJson(body, type);
                if (avatorBeen != null) {
                    ...
                    if (retmsg != null && retmsg.contains("[")) {
                        ...
                        ArrayList<AddMessageBean> list1 = mGson.fromJson(substring, type1);
                        for (AddMessageBean messageBean : list1) {
                            if (messageBean.getCL_ChatlogType().equals("txt")) {
...
/*
        ...
        uploadimg.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                Log.i(TAG, "onResponse:      请求成功的返回" + response.body().toString());
            }

            @Override
            public void onFailure(Call<String> call, Throwable t) {
                Log.i(TAG, "onResponse:      请求失败的返回" + t.getMessage()  + call.toString() );
    ...
    protected void sendMessage(EMMessage message){
        ...
        if (sendType != null) {
            Call<String> saveChatLog = mApiinterface.saveChatLog(message.getFrom(), message.getTo(), message.getBody().toString(), sendType);
            saveChatLog.enqueue(new Callback<String>() {
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if (body != null) {
                        ...
                        ArrayList<AvatorBean> been = mGson.fromJson(body, type1);
